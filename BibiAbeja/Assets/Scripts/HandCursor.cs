...
public class HandCursor : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (pasoNombre == "paso 3" || pasoNombre == "paso 4")
        {
            ...
            if (txtPalabra.Equals("amarillo") || txtPalabra.Equals("rojo") || txtPalabra.Equals("azul") || txtPalabra.Equals("anaranjado") || txtPalabra.Equals("verde") || txtPalabra.Equals("rosa") || txtPalabra.Equals("negro"))
            {
                Debug.Log("Intentando hacer un sonido de: " + txtPalabra);

                audioClip = Resources.Load("Sonidos/Colores/" + txtPalabra, typeof(AudioClip)) as AudioClip;
    ...
    private void Start()
    {
        if (pasoNombre == "paso 3" || pasoNombre == "paso 4")
        {
            SpriteRenderer sprite = figura.GetComponent<SpriteRenderer>();
            sprite.sprite = Resources.Load("Textures/" + txtPalabra + "R", typeof(Sprite)) as Sprite;
